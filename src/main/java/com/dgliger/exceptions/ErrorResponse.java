...
public class ErrorResponse {
    ...
    public static ErrorResponse authentication(UUID errorId, ErrorCode errorCode, String message) {
        return new ErrorResponse(errorId, errorCode, HttpStatus.UNAUTHORIZED, message);
    }
